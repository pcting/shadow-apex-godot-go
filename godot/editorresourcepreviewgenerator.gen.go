...
/*
        If this function returns [code]true[/code], the generator will call [method generate] or [method generate_from_path] for small previews as well. By default, it returns [code]false[/code].
	Args: [], Returns: bool
*/
...
/*
        If this function returns [code]true[/code], the generator will automatically generate the small previews from the normal preview texture generated by the methods [method generate] or [method generate_from_path]. By default, it returns [code]false[/code].
	Args: [], Returns: bool
*/
