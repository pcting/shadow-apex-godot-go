...
func (o *os) Execute(path gdnative.String, arguments gdnative.PoolStringArray, blocking gdnative.Bool, output gdnative.Array, readStderr gdnative.Bool) gdnative.Int {
	...
	ptrArguments[4] = gdnative.NewPointerFromBool(readStderr)
...
func (o *os) GetLowProcessorUsageModeSleepUsec() gdnative.Int {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "get_low_processor_usage_mode_sleep_usec")
...
func (o *os) GetMinWindowSize() gdnative.Vector2 {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "get_min_window_size")
...
/*
        Undocumented
	Args: [{ false menu String} { false label String} { false id Variant} { false meta Variant}], Returns: void
*/
func (o *os) GlobalMenuAddItem(menu gdnative.String, label gdnative.String, id gdnative.Variant, meta gdnative.Variant) {
	...
	ptrArguments[0] = gdnative.NewPointerFromString(menu)
	ptrArguments[1] = gdnative.NewPointerFromString(label)
	ptrArguments[2] = gdnative.NewPointerFromVariant(id)
	ptrArguments[3] = gdnative.NewPointerFromVariant(meta)

	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "global_menu_add_item")
...
/*
        Undocumented
	Args: [{ false menu String}], Returns: void
*/
func (o *os) GlobalMenuAddSeparator(menu gdnative.String) {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "global_menu_add_separator")
...
func (o *os) GlobalMenuClear(menu gdnative.String) {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "global_menu_clear")
...
/*
        Undocumented
	Args: [{ false menu String} { false idx int}], Returns: void
*/
func (o *os) GlobalMenuRemoveItem(menu gdnative.String, idx gdnative.Int) {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "global_menu_remove_item")
...
func (o *os) IsVsyncViaCompositorEnabled() gdnative.Bool {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "is_vsync_via_compositor_enabled")
...
func (o *os) SetLowProcessorUsageModeSleepUsec(usec gdnative.Int) {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "set_low_processor_usage_mode_sleep_usec")
...
func (o *os) SetMaxWindowSize(size gdnative.Vector2) {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "set_max_window_size")
...
func (o *os) SetMinWindowSize(size gdnative.Vector2) {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "set_min_window_size")
...
func (o *os) SetNativeIcon(filename gdnative.String) {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "set_native_icon")
...
func (o *os) SetVsyncViaCompositor(enable gdnative.Bool) {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("_OS", "set_vsync_via_compositor")
...
type OSImplementer interface {
	...
	Execute(path gdnative.String, arguments gdnative.PoolStringArray, blocking gdnative.Bool, output gdnative.Array, readStderr gdnative.Bool) gdnative.Int
	...
	GetGrantedPermissions() gdnative.PoolStringArray
	...
	GetLowProcessorUsageModeSleepUsec() gdnative.Int
	GetMaxWindowSize() gdnative.Vector2
	GetMinWindowSize() gdnative.Vector2
	...
	GlobalMenuAddItem(menu gdnative.String, label gdnative.String, id gdnative.Variant, meta gdnative.Variant)
	GlobalMenuAddSeparator(menu gdnative.String)
	GlobalMenuClear(menu gdnative.String)
	GlobalMenuRemoveItem(menu gdnative.String, idx gdnative.Int)
	...
	RequestPermissions() gdnative.Bool
	...
	SetLowProcessorUsageModeSleepUsec(usec gdnative.Int)
	SetMaxWindowSize(size gdnative.Vector2)
	SetMinWindowSize(size gdnative.Vector2)
	SetNativeIcon(filename gdnative.String)
	...
	SetVsyncViaCompositor(enable gdnative.Bool)
