...
func (o *audioServer) GetBusEffectInstance(busIdx gdnative.Int, effectIdx gdnative.Int, channel gdnative.Int) AudioEffectInstanceImplementer {
	...
	ptrArguments[0] = gdnative.NewPointerFromInt(busIdx)
	ptrArguments[1] = gdnative.NewPointerFromInt(effectIdx)
	ptrArguments[2] = gdnative.NewPointerFromInt(channel)

	// Get the method bind
	methodBind := gdnative.NewMethodBind("AudioServer", "get_bus_effect_instance")
	...
	// If we have a return type, convert it from a pointer into its actual object.
	ret := newAudioEffectInstanceFromPointer(retPtr)

	// Check to see if we already have an instance of this object in our Go instance registry.
	if instance, ok := InstanceRegistry.Get(ret.GetBaseObject().ID()); ok {
		return instance.(AudioEffectInstanceImplementer)
	}

	// Check to see what kind of class this is and create it. This is generally used with
	// GetNode().
	className := ret.GetClass()
	if className != "AudioEffectInstance" {
		actualRet := getActualClass(className, ret.GetBaseObject())
		return actualRet.(AudioEffectInstanceImplementer)
	}
...
func (o *audioServer) GetGlobalRateScale() gdnative.Real {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("AudioServer", "get_global_rate_scale")
...
func (o *audioServer) GetOutputLatency() gdnative.Real {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("AudioServer", "get_output_latency")
...
func (o *audioServer) GetTimeSinceLastMix() gdnative.Real {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("AudioServer", "get_time_since_last_mix")
...
func (o *audioServer) GetTimeToNextMix() gdnative.Real {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("AudioServer", "get_time_to_next_mix")
...
func (o *audioServer) SetGlobalRateScale(scale gdnative.Real) {
	...
	// Get the method bind
	methodBind := gdnative.NewMethodBind("AudioServer", "set_global_rate_scale")
...
type AudioServerImplementer interface {
	...
	GetBusEffectInstance(busIdx gdnative.Int, effectIdx gdnative.Int, channel gdnative.Int) AudioEffectInstanceImplementer
	...
	GetOutputLatency() gdnative.Real
	GetTimeSinceLastMix() gdnative.Real
	GetTimeToNextMix() gdnative.Real
	...
	SetGlobalRateScale(scale gdnative.Real)
